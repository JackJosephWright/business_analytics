...
```{r}
dat<-read.csv('./data/bonds.txt',sep = '\t')
```
...
```{r}
dat<-read.csv('./data/cleaning.txt',sep='\t')
```
...
dat<-read.table("C:/Program Files/GitHub/business_analytics/Modern_approach_with_r/data/salarygov.txt")
